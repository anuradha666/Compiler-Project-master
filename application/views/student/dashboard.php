    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <a href="<?php echo base_url('index.php/student/compiler/index');?>">
                        <span class="icon"><ion-icon name="home-outline"></ion-icon></span>
                        <span class="title">ONLINE COMPILER</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="<?php echo base_url('index.php/student/workspace/index'); ?>">
